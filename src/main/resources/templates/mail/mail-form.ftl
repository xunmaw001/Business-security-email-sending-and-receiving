...
<div id="body_content">
    <div class="mail_form">
        ...
        <#--<div class="button">标记为</div>-->
                        ...
                        <ul id="mail_desc">
                            <li>
                                ...
                                <div class="item_content">
                                    <input type="text" id="recipient" name="toUser" size="100" style="border:none;"/>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div class="item_content">
                                    <input type="text" id="subject" name="subject" size="100" style="border:none;"/>
                                </div>
                            </li>
                            <hr style="width: 100%;border:1px solid #D7DFEB;margin-top: 10px;"/>
                            <li>
            ...
            <div class="content">
                <script id="editor" class="editor-form" type="text/plain" name="content"></script>
