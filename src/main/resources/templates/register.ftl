...
<div class="container-fluid">
    <div class="row cb-slideshow-text-container ">
        <div class="tm-content col-xl-6 col-sm-8 col-xs-8 ml-auto section">
            <header class="mb-5"><h1>创建邮箱账号</h1></header>
            <P class="mb-5">自定义创意邮箱，让彼此的距离更近</P>

            <form id="registerWindowForm" method="post" class="subscribe-form" enctype="multipart/form-data">
                <div class="row form-section">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
                        <input name="pwdHash" id="password" type="password" class="form-control"
                               id="contact_email" placeholder="Your Password..." required/>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
                        <input name="confirm" id="confirm" type="password" class="form-control"
                               id="contact_email" placeholder="confirm Password..." required/>
                    </div>
                    <div class="col-md-5 col-sm-5 col-xs-5" style="margin-top: 10px;">
                        <button type="button" onclick="memberRegister()" class="tm-btn-subscribe">注册</button>
                    </div>
