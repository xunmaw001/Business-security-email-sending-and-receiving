        ...
        <div class="btn-group">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li><a href="" onclick="moveToSpam('delete','spam')">垃圾邮件</a></li>
                    <li><a href="" onclick="moveToSpam('delete','mail')">正常邮件</a></li>
                </ul>
            </div>
        </div>
    ...
    <#--</div>-->
        <div class="mail-list">
            ...
            <#--</thead>-->
                <tbody>
            <#if deleteMailList??>
                <#list deleteMailList as deleteMail>
                 <tr>
                     <td width="5%"><input type="checkbox" name="mailId" value="${(deleteMail.id)!}"/><input type="hidden" id="mailId"
                                                                   value="${(deleteMail.id)!}"/></td>
                     <td width="15%"><a style="cursor: pointer"
                                        onclick="changeiframe('/deleteMail/showDeleteMail',${(deleteMail.id)!})"> ${(deleteMail.fromUser)!}</a>
                     </td>
                     <td width="70%"><a style="cursor: pointer"
                                        onclick="changeiframe('/deleteMail/showDeleteMail',${(deleteMail.id)!})"> ${(deleteMail.subject)!}</a>
                     </td>
                     <td width="10%"><a style="cursor: pointer"
                                        onclick="changeiframe('/deleteMail/showDeleteMail',${(deleteMail.id)!})">${(deleteMail.sentDate?string("yyyy-MM-dd"))!}</a>
                     </td>
